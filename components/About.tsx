        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="grid grid-cols-2 gap-4">
              <img src="https://picsum.photos/seed/bangsar1/500/600" alt="Bangsar Clinic" className="rounded-3xl shadow-lg mt-12" />
              <img src="https://picsum.photos/seed/dental2/500/600" alt="Modern Dental Equipment" className="rounded-3xl shadow-lg" />
            </div>
            {/* Years badge */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-8 rounded-full shadow-2xl border-8 border-ivory text-center w-48 h-48 flex flex-col justify-center">
              <span className="text-terracotta font-bold text-4xl block">34+</span>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-sans">
              <p>
                In 1991, Dato' Dr. Balakrishnan opened Bala Dental Clinic in Bangsar with a simple mission: to provide quality, affordable dental care for families in the community.
              </p>
              <p>
                Over three decades later, we've grown to serve patients across two locations in Bangsar and Klang. Our commitment to excellence remains unchanged — combining years of expertise with modern dental techniques.
              </p>
              <p>
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              <div className="space-y-2">
                <p className="text-3xl font-serif text-ttdi-green">1991</p>
              ...
              <div className="space-y-2">
                <p className="text-3xl font-serif text-ttdi-green">15,000+</p>
